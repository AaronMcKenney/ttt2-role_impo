...
hook.Add("TTTUlxDynamicRCVars", "TTTUlxDynamicImpostorCVars", function(tbl)
	...
	--  ttt2_impostor_sabo_comms_length [0..n] (default: 20)
	table.insert(tbl[ROLE_IMPOSTOR], {
	...
	--  ttt2_impostor_sabo_o2_length [0..n] (default: 30)
	table.insert(tbl[ROLE_IMPOSTOR], {
	...
	table.insert(tbl[ROLE_IMPOSTOR], {
		cvar = "ttt2_impostor_sabo_react_win_mode",
		combobox = true,
		desc = "ttt2_impostor_sabo_react_win_mode (Def: 0)",
		choices = {
			"0 - Everyone loses",
