if SERVER then
    ...
    resource.AddFile("materials/vgui/ttt/vskin/events/impo_sabo_success.vmt")
end

if CLIENT then
	EVENT.title = "title_event_impo_sabo_success"
	EVENT.icon = Material("vgui/ttt/vskin/events/impo_sabo_success.vmt")
