...
L["INFORM_" .. IMPOSTOR.name] = "Обнаружено {n} предателей среди нас..."
...
L["SABO_REACT_STRANGE_GAME" .. IMPOSTOR.name] = "СТРАННАЯ ИГРА"

-- EVERYONE LOSES EVERYONE LOSES EVERYONE LOSES
L["win_everyones"] = "ВСЕ ПРОИГРАЛИ"
L["hilite_win_everyones"] = "ВСЕ ПРОИГРАЛИ"
L["ev_win_everyones"] = "ВСЕ ПРОИГРАЛИ"